...
const docTemplate = `{
    ...
    "basePath": "{{.BasePath}}",
    "paths": {
        "/api/v1/private/user/get-full-list": {
            "get": {
                "security": [
                    {
                        "ApiKeyAuth": []
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/response.UserFullListResponse"
                        }
                    },
                    "500": {
        ...
        "response.UserFullListResponse": {
            ...
            "properties": {
                ...
                "r": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/model.UserWithStats"
                    }
                },
                "s": {
                    "type": "integer",
